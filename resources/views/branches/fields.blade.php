      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
          <div class="col-md-4">
            ...
            {!! Form::text('name', null, ['class' => 'form-control input-lg', 'placeholder'=>'ESCRIBE EL NOMBRE DE LA SUCURSAL','required'=>'required']) !!}
          </div>
          <div class="col-md-4">
            <label for="exampleInputEmail1">Teléfono</label>
            {!! Form::text('phone', null, ['class' => 'form-control input-lg','placeholder'=>'ESCRIBE SU NÚMERO DE TELÉFONO','required'=>'required']) !!}
          </div>       
        </div>
        <!-- /.box-body -->        
        <div class="box-body">
          <div class="col-md-10">
            <div class="gllpLatlonPicker">
              ...
              <div class="input-group">
                {!! Form::text('address', null, ['class' => 'form-control input-lg gllpSearchField','placeholder'=>'ESCRIBE LA DIRECCIÓN DE LA SUCURSAL, EJ: AV. CENTRAL OTE. 214 SAN MARCOS, TUXTLA GUTIÉRREZ, CHIS.','required'=>'required']) !!}
