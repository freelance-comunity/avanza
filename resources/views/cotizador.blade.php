      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
          ...
          <div id="diario" style="display: none;">
            ...
            <div class=" col-sm-6 col-lg-12 "  class="slidecontainer">
              <input type="range" min="500" max="10000" value="5000" class="slider" name="capitalr" onChange="calcularr()" id="capitalr">
            </div>
            <br>
...
<!--SCRIPTS PROMOTOR-->
<script>
  function calcularPromotor()
  {
    capitalPromotor = eval(document.getElementById('myRangePromotor').value);
    tasaPromotor = eval(document.getElementById('tasaPromotor').value);
    interesPromotor = capitalPromotor * tasaPromotor;

    document.getElementById('interesPromotor').value=interesPromotor;
    modalidadPromotor = eval(document.getElementById('modalidadPromotor').value);

    utilidad_netaPromotor = capitalPromotor + interesPromotor;
    totalPromotor= utilidad_netaPromotor/modalidadPromotor;
    var formatterPromotor = new Intl.NumberFormat('en-US', {
      style: 'currency',
      currency: 'USD',
      minimumFractionDigits: 2,
    });
    ...
    document.getElementById('totalnPromotor').value=formatterPromotor.format(Math.ceil(totalPromotor));
    document.getElementById('refrendoPromotor').value=formatterPromotor.format(Math.ceil(interesPromotor));         
  }
  function calcularcredi4()
  {
    capitalfour = eval(document.getElementById('capitalfour').value);
...
<script>
  var sliderPromotor = document.getElementById("myRangePromotor");
  var outputPromotor = document.getElementById("demoPromotor");
  outputPromotor.innerHTML = sliderPromotor.value;

  sliderPromotor.oninput = function() {
    outputPromotor.innerHTML = this.value;
  }
</script>
