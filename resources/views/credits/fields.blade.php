                        ...
                        <div class="form-group col-sm-6 col-lg-4">
                          ...
                          <div class="form-group col-sm-6 col-lg-4">
                            ...
                            @endforeach
                             ...
                             <div class="form-group col-sm-6 col-lg-4">
                              {!! Form::label('firts_name_reference', 'Last Name Reference:') !!}
                            ...
                            <div class="form-group col-sm-6 col-lg-4">
                              {!! Form::label('mothers_last_name_reference', 'Mothers Last Name Reference:') !!}
                              {!! Form::text('mothers_last_name_reference', null, ['class' => 'form-control']) !!}
                            </div>
