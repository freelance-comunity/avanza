<div class="box box-danger">
	...
	<div class="box-body">
		...
		<div class="form-group col-sm-6 col-lg-4">
			...
			<input type="email" class="form-control input-lg" placeholder="EJEMPLO@GMAIL.COM" name="email" value="{{ $employee->email }}" value="{{ old('email') }}" required="required" />
		</div>

		<div class="form-group col-sm-6 col-lg-4">
			{!! Form::label('birthdate', 'Fecha de Nacimiento:') !!}
			<input type="date" name="birthdate" value="{{ $employee->birthdate }}" class="form-control input-lg" required="required">
		</div>
