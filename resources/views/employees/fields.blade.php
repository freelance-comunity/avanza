                        ...
                        <div class="form-group col-sm-6 col-lg-4">
                            ...
                            <div class="form-group col-sm-6 col-lg-4">
                                ...
                                <div class="form-group col-sm-6 col-lg-4">
                                    ...
                                    <input type="email" class="form-control input-lg" placeholder="EJEMPLO@GMAIL.COM" name="email" value="{{ old('email') }}" required="required" data-parsley-type="email"/>
                                </div>
                                ...
                                <div class="form-group col-sm-6 col-lg-4">
                                    ...
                                    {!! Form::text('phone_2', null, ['style' => 'text-transform:uppercase','class' => 'form-control input-lg', 'placeholder' => 'TELÉFONO 2', 'onkeyup' => 'javascript:this.value=this.value.toUpperCase();']) !!}
                                </div>
