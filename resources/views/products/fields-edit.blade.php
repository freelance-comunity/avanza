        ...
        <div class="form-group col-sm-6 col-lg-4">
          ...
          <div class="form-group col-sm-6 col-lg-4">
            ...
            <div class="form-group col-sm-6 col-lg-4">
              ...
              <input type="number" name="ammount_max" class="form-control input-lg" placeholder="ESCRIBE EL MONTO MÁXIMO" required="required" data-parsley-trigger="input focusin" data-parsley-type="digits" data-parsley-maxlength="5" value="{{ $product->ammount_max }}">
              </div> 


              <div class="form-group col-sm-6 col-lg-4">
                {!! Form::label('ammount_min', 'Monto Mínimo:') !!}
                <input type="number" name="ammount_min" class="form-control input-lg" placeholder="ESCRIBE EL MONTO MÍNIMO" required="required" data-parsley-trigger="input focusin" data-parsley-type="digits" data-parsley-maxlength="5" value="{{ $product->ammount_min }}">
                </div> 
