...
<body>
    ...
    <table>
      <thead>
        <tr>
          ...
          <th class="desc">APELLIDO PATERNO</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="desc">{{ $user->father_last_name }}</td>
          <td class="desc">{{ $user->mother_last_name }}</td>
          <td class="total">${{ number_format($vault->ammount,2) }}</td>
        </tr>
        @endforeach
        <tr>
          <td colspan="3" class="grand total">TOTAL</td>
          <td class="grand total">${{ number_format($vault_total->sum('ammount'),2) }}</td>
        </tr>
      </tbody>
    </table>
    <div id="notices">
  ...
  <footer>
    El reporte fue creado en el sistema de crediefectivo.mx.
  </footer>
</body>
</html>