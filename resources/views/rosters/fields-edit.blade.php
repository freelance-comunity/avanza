  ...
  <div class="box-body">
    ...
    {{-- <div class="form-group col-sm-6 col-lg-6">
        {!! Form::label('perceptions', 'Percepciones:') !!}
            <input type="text" name="perceptions" readonly="readonly" class="form-control input-lg" id="percepciones" onkeyup="calcular()">
    </div>

    <div class="form-group col-sm-6 col-lg-6">
        {!! Form::label('deductions', 'Deducciones:') !!}
            <input type="text" name="deductions" readonly="readonly" value="0" class="form-control input-lg" id="deducciones" onkeyup="calcular()">
    </div>
