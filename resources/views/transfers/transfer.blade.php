<div class="modal fade" id="transferencias" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">TRANSFERENCIA</h3>
      ...
      {{-- {!! Form::open(['url' => 'process','data-parsley-validate' => '','onsubmit'=>'return enviado()']) !!}  --}}
       {!! Form::open(['route' => 'transfers.store','data-parsley-validate' => '','onsubmit'=>'return enviado()']) !!}
        <p>
